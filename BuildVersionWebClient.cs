...
namespace BuildTool
{
    ...
    public static class BuildVersionWebClient
    {
        ...
        /// </summary>
        private static readonly DataContractJsonSerializerSettings settings = new DataContractJsonSerializerSettings { DateTimeFormat = new DateTimeFormat(BuildVersion.TIME_FORMAT, CultureInfo.InvariantCulture) };
        /// <summary>

...
namespace UnityBuildTool.Versioning
{
    /// <summary>
    /// Game version info class
    /// </summary>
    public static class GameVersion
    {
        #region Constants
        /// <summary>Build ID file extension</summary>
        ...
        /// <summary>Build file Regex pattern</summary>
        ...
        /// <summary>
        /// True if a valid version file has been found, false otherwise
        /// </summary>
        ...
        static GameVersion()
        {
            ...
            if (!File.Exists(path))
            {
                ...
                //Throw to notify
                throw new FileNotFoundException("Game version file could not be found", path);
            }

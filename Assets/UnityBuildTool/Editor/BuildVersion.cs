...
namespace UnityBuildTool
{
    ...
    public class BuildVersion
    {
        ...
        #region Constants
        /// <summary>File extension of the build files</summary>
        public const string EXTENSION = ".build";
        /// <summary>The Build time format string</summary>
        public const string TIME_FORMAT = "dd/MM/yyyy-HH:mm:ssUTC";
        /// <summary>The regex pattern to parse the build file</summary>
        ...
        public static BuildVersion FromFile()
        {
            ...
            else
            {
                try
                {
                    ...
                    build.Log("Version object successfully loaded from file");
                    return build;
                }
                catch (Exception e)
                {
        ...
        {
            this.infoBuilder.Length = 0;
            this.infoBuilder.AppendLine("Version: " + this.VersionString);
            this.infoBuilder.AppendLine("Build Time: " + this.BuildTime.ToString(TIME_FORMAT, CultureInfo.InvariantCulture));
            this.infoBuilder.AppendLine("Author: " + this.Author);
            return this.infoBuilder.ToString();
        }
        #endregion
    }
}

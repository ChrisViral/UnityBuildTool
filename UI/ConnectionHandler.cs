...
namespace BuildTool.UI
{
    ...
    public class ConnectionHandler
    {
        ...
        /// </summary>
        private static readonly Dictionary<GitHubAuthenticator.ConnectionStatus, string> status = new Dictionary<GitHubAuthenticator.ConnectionStatus, string>(6)
        {
            [GitHubAuthenticator.ConnectionStatus.NONE]            = "Connecting to API, please wait...",
            [GitHubAuthenticator.ConnectionStatus.NOT_CONNECTED]   = "Please enter your GitHub credentials",
            [GitHubAuthenticator.ConnectionStatus.BAD_CREDENTIALS] = "Invalid credentials, please try again",
            [GitHubAuthenticator.ConnectionStatus.REQUIRES_2FA]    = "2FA Code required",
            [GitHubAuthenticator.ConnectionStatus.FAILED_2FA]      = "2FA verification failed, please try again",
            [GitHubAuthenticator.ConnectionStatus.CONNECTED]       = string.Empty
        };
        ...
        public void OnGUI()
        {
            ...
            if (!this.window.Authenticator.IsConnected)
            {
                ...
                {
                    case GitHubAuthenticator.ConnectionStatus.NOT_CONNECTED:
                    case GitHubAuthenticator.ConnectionStatus.BAD_CREDENTIALS:
                        ...
                        {
                            GUI.FocusControl(this.window.Authenticator.Status == GitHubAuthenticator.ConnectionStatus.BAD_CREDENTIALS ?  nameof(this.pass) : nameof(this.user));
                    ...
                    case GitHubAuthenticator.ConnectionStatus.REQUIRES_2FA:
                    case GitHubAuthenticator.ConnectionStatus.FAILED_2FA:
